...
char* Uint2String(LmHandlerAppData_t *appData)
{
...
void SendTxData(void)
{
	...
	//char* data_to_send = "Some device data :-)";//{'S' ,'o' ,'m' ,'e' ,' ' ,'d' ,'e' ,'v' ,'i' ,'c' ,'e' ,' ' ,'d' ,'a' ,'t' ,'a' ,' ' ,':', '-', ')'};
	//AppData.Buffer = (uint8_t *) data_to_send;
	//AppData.BufferSize = 20;
	//APP_LOG(TS_ON, VLEVEL_M, "Sending data: %s :-) \r\n",AppData.Buffer);
